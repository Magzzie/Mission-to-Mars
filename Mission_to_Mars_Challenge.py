...
for result in range(len(results[:-1])):
    ...
    # Create a dictionary to hold the image url and title 
    hemispheres = {
        'img_url': img_url, 
        'title': title
    }
    
    # Before getting the next image URL and title, add the dictionary with the image URL string and the hemisphere image title to the list
